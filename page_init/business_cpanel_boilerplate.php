...
<body>
    ...
    <div class="container text-center">
        ...
        <div class="container text-center form-group col-md-4 col-lg-4">
            <h3 class="display-3">Add employees</h1>
            <form method="POST" action="business_cpanel_boilerplate.cphp">
            <span class="label label-default" for="emp">Employee:</span>
            <input class="form-control" type="text" name="emp" id="emp" placeholder="Add employee">
            <input type="submit" value="Add" class="btn btn-outline-dark" name="add">
            </form>
        </div>
    </div>
