...
<body>
    ...
    <div class="container text-center col-md-4 col-lg-4">
        <div class="form-group">
            <input type="text" class="form-control mb-2" name="receiver" placeholder="Receiver">
            <textarea row="4" col="4" name="message"></textarea>
            <button class="btn btn-outline-dark" onclick="sendmessage()">Send Message</button>
        </div>
    </div>
